...
import { handlePlanPayment } from '../utils/handlePlanPayment';  // import the handler

const StandardPlansCart = () => {
  const plan = {
    id: 'plan2',
    name: 'Standard Plan',
    description: 'Daily delivery of 200g of fresh flowers. Ideal for personal spaces or daily devotional use.',
    price: 1499,
...
export default StandardPlansCart;
