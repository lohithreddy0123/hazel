...
import { handlePlanPayment } from '../utils/handlePlanPayment';


const BasicPlansCart = () => {
  const plan = {
    id: 'plan1',
    name: 'Base Plan',
    description: 'Daily delivery of 100g of fresh flowers. Ideal for personal spaces or daily devotional use.',
    price: 1,
